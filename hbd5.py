...
def run_hbd():
    # Kode Python yang ingin dijalankan
    result = "🎉 Selamat! Python dijalankan dan tombol berhasil ditekan! 🎉"
    print("Tombol ditekan, cek terminal!")  # Ini muncul di terminal/server
    return result  # Akan dikirim ke frontend dan ditampilkan di div
